...
type InfoClient interface {
	Show(ctx context.Context, in *Tea, opts ...grpc.CallOption) (*Tea, error)
}
...
func (c *infoClient) Show(ctx context.Context, in *Tea, opts ...grpc.CallOption) (*Tea, error) {
	out := new(Tea)
	err := c.cc.Invoke(ctx, "/pb.Info/Show", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InfoServer interface {
	Show(context.Context, *Tea) (*Tea, error)
...
func (UnimplementedInfoServer) Show(context.Context, *Tea) (*Tea, error) {
...
func _Info_Show_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Info/Show",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InfoServer).Show(ctx, req.(*Tea))
	}
